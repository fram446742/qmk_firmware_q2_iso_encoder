...
#define IND_WIN_LOCK_ON    {255, 0, 0}      ///< Win Lock (no GUI) active — red, drawn in every state
#define IND_WIN_LOCK_OFF   {0, 255, 0}      ///< Win Lock released — green, overlay screens only (never over an effect)
