...
#        endif
    ...
    if (params->init) {
        KC_RGB_SET_COLOR_ALL(params, 0, 0, 0);
    }
                ...
                for (uint8_t h = 0; h < MATRIX_ROWS; ++h) {
                    ...
                    for (uint8_t l = 0; l < MID_COL - 1; ++l) {
                        ...
                        if (HAS_ANY_FLAGS(g_led_config.flags[g_led_config.matrix_co[h][l]], params->flags)) {
                            KC_RGB_SET_COLOR(params, g_led_config.matrix_co[h][l], index_rgb.r, index_rgb.g, index_rgb.b);
                        }
                        if (HAS_ANY_FLAGS(g_led_config.flags[g_led_config.matrix_co[h][MATRIX_COLS - 1 - l]], params->flags)) {
                            KC_RGB_SET_COLOR(params, g_led_config.matrix_co[h][MATRIX_COLS - 1 - l], index_rgb.r, index_rgb.g, index_rgb.b);
                        }
                        led[h][l] = led[h][l + 1];
                    }
                    ...
                    if (HAS_ANY_FLAGS(g_led_config.flags[g_led_config.matrix_co[h][MID_COL - 1]], params->flags)) {
                        KC_RGB_SET_COLOR(params, g_led_config.matrix_co[h][MID_COL - 1], index_rgb.r, index_rgb.g, index_rgb.b);
                    }
                    if (HAS_ANY_FLAGS(g_led_config.flags[g_led_config.matrix_co[h][MATRIX_COLS - MID_COL]], params->flags)) {
                        KC_RGB_SET_COLOR(params, g_led_config.matrix_co[h][MATRIX_COLS - MID_COL], index_rgb.r, index_rgb.g, index_rgb.b);
                    }
